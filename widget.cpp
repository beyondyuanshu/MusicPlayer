    ...
    ui(new Ui::Widget)
{
    ...
    mList->ui->tableWidget->setColumnWidth(0,150);
...
void Widget::Timeout()//若0.1秒不显示歌词，则显示“Music ...”
{
    if(lrc->text().isEmpty())
    {
        lrc->setText(tr("yafeilinux作品"));
        ui->label_lrc->setText(tr("yafeilinux作品"));
    }
}
...
void Widget::on_toolButton_open_clicked()//打开
{
    QStringList list = QFileDialog::getOpenFileNames(
            this,tr("打开音乐文件"), QDesktopServices::storageLocation(QDesktopServices::MusicLocation));
